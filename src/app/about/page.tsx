  ...
  return (
    <div style={{ paddingTop: "var(--nav-height)" }}>
      <style>{`
        ...
        .about-image { position: relative; min-height: 600px; overflow: hidden; }
        .about-text { padding: 5rem 4rem; display: flex; flex-direction: column; justify-content: center; border-left: 0.5px solid var(--charcoal); }
        .about-stats { padding: 4rem 2.5rem; border-top: 0.5px solid var(--charcoal); display: flex; gap: 4rem; flex-wrap: wrap; }
        .about-cta { padding: 4rem 2.5rem; border-top: 0.5px solid var(--charcoal); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1.5rem; }
      ...
      <div className="about-grid">
        <div className="about-image">
          <Image src="/about.jpg" alt="Sina Sharifi" fill style={{ objectFit: "contain", objectPosition: "center center", background: "#e8e4de" }} priority />
        </div>
        <div className="about-text">
          <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: "10px", letterSpacing: "0.18em", textTransform: "uppercase", color: "#9a9189", margin: "0 0 2rem" }}>About</p>
          ...
          <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "19px", fontWeight: 300, color: "#3a3530", lineHeight: 1.8 }}>
            <p style={{ margin: "0 0 1.5rem", fontStyle: "italic" }}>
              I was born into an Afghan family. I have never had one home.
            </p>
            <p style={{ margin: "0 0 1.5rem" }}>
              I grew up across several countries before settling — briefly — in California, then Germany. In 2019 my wife and I chose to take the road permanently. We have been moving ever since.
            </p>
            <p style={{ margin: "0 0 1.5rem" }}>
              A camera came into my life as a graduation gift. It was never about money or an audience — it was a way of seeing. A wide angle humbles you. A macro reveals what most people walk past. A portrait brings you face to face with a stranger.
            </p>
      ...
      <div className="about-stats">
        {[
          ...
          <div key={item.label}>
            <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: "10px", letterSpacing: "0.16em", textTransform: "uppercase", color: "#9a9189", margin: "0 0 6px" }}>{item.label}</p>
            <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "20px", color: "#1a1814", margin: 0 }}>{item.value}</p>
          </div>
        ))}
      </div>
